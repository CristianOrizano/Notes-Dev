...
Un contenedor es una instancia en ejecución de una imagen de Docker, lo que hace es encapsular una aplicación y sus dependencias para que se ejecute de forma consistente en diferentes entornos.
